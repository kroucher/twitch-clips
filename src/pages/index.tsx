...
const Home: NextPage = () => {
  ...
  const { data, status, fetchNextPage, hasNextPage } = trpc.streamers.searchStreamers.useInfiniteQuery({
    query: search,
  }, {
  ...
  return (
    <div className="w-full bg-slate-900 flex flex-col items-center justify-center">
      ...
      <main className="container flex flex-col items-center justify-center min-h-screen h-full w-full   relative">
        <h1 className="text-3xl pb-10 text-white">Twitch Clips</h1>
        <input
        ...
        <InfiniteScroll
          ...
          hasMore={hasNextPage}
          loader={loader}
          className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 mx-auto content-center w-full gap-2 pt-24 mx-auto"
        >
